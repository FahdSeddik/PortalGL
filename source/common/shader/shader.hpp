...
namespace our {
    ...
    public:
        ...
        void set(const std::string &uniform, glm::vec2 value) {
            ...
            glUniform2fv(glGetUniformLocation(program, uniform.c_str()), 1, glm::value_ptr(value));
        }
        ...
        void set(const std::string &uniform, glm::vec4 value) {
            ...
            glUniform4fv(glGetUniformLocation(program, uniform.c_str()), 1, glm::value_ptr(value));
        }
        ...
        //Answer: Because we don't want to copy the program object, we want to use the same program object in all the shaders.
